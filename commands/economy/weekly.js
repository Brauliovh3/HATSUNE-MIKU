export default {
  ...
  run: async (client, m, args, usedPrefix) => {
    ...
    if (now < user.lastweekly) {
      ...
      return client.reply(m.chat, `🌱 ${global.miku || 'HATSUNE MIKU'} Ya has reclamado tu recompensa semanal.\n> Puedes reclamarlo de nuevo en *${wait}*`, m)
    }
    ...
    client.reply(m.chat, `🌱 ${global.miku || 'HATSUNE MIKU'} Has reclamado tu recompensa semanal de *¥${coins.toLocaleString()} ${currency}* (Semana *${users.weeklyStreak}*)\n${msg}`, m)
  },
}
