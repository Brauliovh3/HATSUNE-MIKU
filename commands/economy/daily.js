export default {
  ...
  run: async (client, m, args, usedPrefix) => {
    ...
    if (now < user.lastdaily) {
      ...
      return m.reply(`🌱 ${global.miku || 'HATSUNE MIKU'} Ya has reclamado tu *Daily* de hoy.\n> Puedes reclamarlo de nuevo en *${restante}*`)
    }
    ...
    await m.reply(`🌱 ${global.miku || 'HATSUNE MIKU'} Has reclamado tu recompensa diaria de *¥${recompensa.toLocaleString()} ${monedas}*! (Día *${users.streak}*)\n${msg}`)
  },
}
